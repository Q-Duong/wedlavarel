                            ...
                            @foreach($edit_product as $key =>$pro)
                                ...
                                {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$pro->product_name}}" name="product_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img class="img-fluid" src="{{URL::to('public/uploads/product/'.$pro->product_image)}}" alt="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_content" value="{{$pro->product_content}}" style="resize:none" rows=8 class="form-control"
